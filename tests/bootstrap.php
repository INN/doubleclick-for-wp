<?php
/**
 * DoubleClick_For_WordPress Test Bootstrapper.
 *
 * @since   0.2.1
 ...
 * @since 0.2.1
 */
function _manually_load_doubleclick_for_wordpress_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/doubleclick-for-wordpress.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_doubleclick_for_wordpress_plugin' );
